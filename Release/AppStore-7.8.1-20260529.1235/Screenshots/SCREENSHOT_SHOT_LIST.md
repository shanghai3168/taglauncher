...
```bash
mkdir -p Release/AppStore-7.8.1-20260529.1235/Screenshots/AppStore
for file in Release/AppStore-7.8.1-20260529.1235/Screenshots/raw/*.png; do
  name="$(basename "$file")"
  sips -z 1800 2880 "$file" --out "Release/AppStore-7.8.1-20260529.1235/Screenshots/AppStore/$name"
done
```
