...
- [ ] Verify `CFBundleShortVersionString = 7.8.1`.
- [ ] Start from frozen local QA build `20260529.1235`; use a newer `CFBundleVersion` only if App Store upload retries require it.
...
- [ ] Attach the processed build to version `7.8.1`.
